...
| `setup_yandex_direct_mcp.py` | подключение MCP к настольному агенту |
...
- Стратегию торгов, привязку целей Метрики, быстрые ссылки, уточнения и часть форматов может потребоваться завершить вручную — это зависит от подключённого MCP.
