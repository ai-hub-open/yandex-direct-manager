...
| `references/mcp-account-integration.md` | Шаг 2 + Шаг 10 | **Сценарии по шагам:** аудит аккаунта, дедупликация, оценка CPC, регионы и полная последовательность заливки (Use case 5) |
